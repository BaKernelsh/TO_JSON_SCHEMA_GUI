...
public class JSONValidator {
    ...
    private String firstUnknownKeyword;
    ...
    public boolean validateAgainstSchema(JSONTreeNode node, JSONObjectTN schema) throws Exception {
        ...
        for(var assertion : assertions){
            ...
            if(!resultForAssertion) {
                result = false;
                if(firstUnknownKeyword==null)
                    firstUnknownKeyword = assertion.getName();
            }
    ...
    public String getFirstUnknownKeyword(){
        return firstUnknownKeyword;
    }
}
